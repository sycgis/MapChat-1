...
public class PlacesSearch {
    ...
    public void getPlaces() {
        try {
            ...
            urlBuilder.append("&radius=1000"); //radius in meters, default rank is prominence
            ...
            try {
                ...
                for (int i = 0; i < placeNames.size(); i++) {
                	System.out.println("Place " + (i+1) + ": " + placeNames.get(i));
                	System.out.println("Address: " + placeAddresses.get(i));
                	System.out.println("Phone Number: " + placePhones.get(i) + "\n");
            	}
